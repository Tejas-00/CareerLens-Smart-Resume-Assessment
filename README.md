<div align="center">
  ...
  <h3 align="center">CareerLens Smart Resume Assessment</h3>
...
```bash
git clone https://github.com/Tejas-00/CareerLens-Smart-Resume-Assessment.git
cd CareerLens-Smart-Resume-Assessment
```
